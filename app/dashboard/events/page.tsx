        ...
        <div className="space-y-6 sm:space-y-8">
              ...
              <Table className="min-w-[640px]">
                ...
                <TableBody className="bg-white">
                  {upcomingEvents.map((event) => {
                    ...
                    return (
                      <TableRow key={event.id} className="hover:bg-green-50/50">
          ...
          {pastEvents.length > 0 && (
            <Card className="bg-gradient-to-br from-gray-50 to-slate-50 shadow-sm border border-gray-300 overflow-hidden p-0">
              ...
              <Table className="min-w-[640px] bg-white/50">
                ...
                <TableBody className="bg-white/30">
                  {pastEvents.map((event) => {
                    const eventDates = parseEventDates(event.date)
                    return (
                      <TableRow key={event.id} className="hover:bg-slate-100/50 opacity-90">
                        <TableCell className="px-3 sm:px-6 py-4">
                          <Link
                            href={`/dashboard/events/${event.id}`}
                            prefetch={false}
                        ...
                        <TableCell className="px-3 sm:px-6 py-4">
                          <Badge variant="secondary" className="bg-slate-200 text-slate-700 border border-slate-300 hover:bg-slate-200">
                            Past
                          </Badge>
                        </TableCell>
                        <TableCell className="px-3 sm:px-6 py-4 text-right">
