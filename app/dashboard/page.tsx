...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl space-y-4 sm:space-y-6">
      {/* Welcome Section */}
      <Card className="bg-linear-to-r from-indigo-500 to-blue-600 shadow-lg text-white border-0">
          ...
          <Card className="shadow-sm">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <Button asChild variant="link" className="text-indigo-600 hover:text-indigo-700 h-auto p-0 text-xs sm:text-sm">
