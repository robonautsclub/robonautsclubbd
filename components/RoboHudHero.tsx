...
type Props = {
  children: ReactNode
  /** Compact padding for album / secondary heroes */
  compact?: boolean
  className?: string
...
export default function RoboHudHero({
  children,
  compact = false,
  className,
  contentClassName,
  ...
  return (
    <section className={cn('relative overflow-hidden bg-[#050816] text-white', className)}>
      <div
      ...
      <div
        className={cn(
          ...
          compact ? 'py-10 sm:py-12 md:py-14' : 'py-14 sm:py-16 md:py-20',
